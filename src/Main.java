...
public class Main {
    ...
    public static final Prompt prompt = new Prompt(new String[]{"Demo1", "Demo2", "Demo3", "Demo4", "Demo5", "Demo6", "Demo7", "Demo8", "Demo9"});
    ...
    public static void main(String[] args) throws Exception {
        ...
        int demoID = Integer.parseInt(String.valueOf(prompt.input.charAt(4)));
